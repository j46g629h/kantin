...
const I18N = {
  ...
  zh: {
    ...
    'accounts.rename':       '改名字',
    'accounts.renameTitle':  '修改姓名',
    'accounts.renameLabel':  '姓名',
    'accounts.renameHint':   '只影響往後顯示的名字。已經處理過的案件仍會顯示當時的名字（那是稽核紀錄）。',
    'accounts.renameSave':   '儲存',
    'accounts.renaming':     '儲存中…',
    'accounts.renamed':      '已改名為「{name}」',
    'accounts.renameNoChange':'姓名沒有變更',
  ...
  id: {
    ...
    'accounts.rename':       'Ubah Nama',
    'accounts.renameTitle':  'Ubah Nama',
    'accounts.renameLabel':  'Nama',
    'accounts.renameHint':   'Hanya untuk tampilan ke depan. Laporan yang sudah ditangani tetap menampilkan nama waktu itu (itu catatan audit).',
    'accounts.renameSave':   'Simpan',
    'accounts.renaming':     'Menyimpan…',
    'accounts.renamed':      'Nama sudah diubah jadi "{name}"',
    'accounts.renameNoChange':'Nama tidak berubah',
